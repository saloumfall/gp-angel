...
const Rsvp = require('./models/Rsvp.ts');
...
module.exports = function(app, config) {
  ...
  app.get('/api/v2/event/:id', jwtCheck, (req, res) => {
  ...
  app.get('/api/v2/event/:eventId/rsvps', jwtCheck, (req, res) => {
  ...
  app.get('/api/v2/events/:userId', jwtCheck, (req, res) => {
  ...
  app.put('/api/v2/event/:id', jwtCheck, adminCheck, (req, res) => {
    Event.findById(req.params.id, (err, event) => {
      if (err) {
        return res.status(500).send({message: err.message});
      }
  ...
  app.delete('/api/v2/event/:id', jwtCheck, adminCheck, (req, res) => {
    Event.findById(req.params.id, (err, event) => {
      if (err) {
        return res.status(500).send({message: err.message});
      }
  ...
  // POST a new RSVP
  app.post('/api/v2/rsvp/new', jwtCheck, (req, res) => {
  ...
  app.put('/api/v2/rsvp/:id', jwtCheck, (req, res) => {
